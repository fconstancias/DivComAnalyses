...
Agglomerated dataset at a particular taxonomic rank might be of interest for specific analysis or also to summarise the taxonomic profile at a broader level. It is also meaningful to know the highest taxonomic definition of the ASV. We can do that using the function `phyloseq_get_strains`
